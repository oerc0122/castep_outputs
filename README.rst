...
``.efield``, ``.elastic``, ``.elf_fmt``, ``.elnes_bin``, ``.epme``,
``.epme_bin``, ``.err``, ``.geom``, ``.hug``, ``.magres``, ``.md``, ``.param``,
...
::
   ...
   options:
     ...
     --inc-elnes_bin       Extract .elnes_bin information
     --castep [CASTEP ...]
     ...
     --elnes_bin [ELNES_BIN ...]
                           Extract from ELNES_BIN as .elnes_bin type
