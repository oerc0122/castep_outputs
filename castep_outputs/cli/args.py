...
ARG_PARSER.add_argument("-o", "--output", help="File to write output, default: screen", default=None)
ARG_PARSER.add_argument("-f", "--out-format", help="Output format", choices=SUPPORTED_FORMATS, default="json")

ARG_PARSER.add_argument("-t", "--testing", action="store_true", help="Set testing mode to produce flat outputs")

ARG_PARSER.add_argument("-A", "--inc-all", action="store_true", help="Extract all available information")
